...
def get_ranking_hybrid_interpolating_rank(default_index, query, k, relevant_documents_ids, docs_metadata):
...
def get_ranking_hybrid_interpolating_score(default_index, query, k, relevant_documents_ids, docs_metadata):
